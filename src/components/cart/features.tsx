    ...
    <Typography variant="h2" color="blue-gray" className="mb-4 text-center">
      ...
      <div className="container mx-auto mb-20 text-center">
        <Typography color="dark" className="mb-2 font-bold text-lg">
           AI. Intelligent grocery shopping cart
        </Typography>
        <Typography
          variant="lead"
          className="mx-auto w-full px-4 text-blue-gray-800 md:w-10/12 lg:w-7/12 lg:px-8"
        >
          ionless checkout: swift, secure transactions, minimizing delays, ensuring a seamless, hassle-free shopping experience for all.
        </Typography>
      </div>
